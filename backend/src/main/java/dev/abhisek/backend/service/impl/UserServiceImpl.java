...
import dev.abhisek.backend.dto.*;
...
public class UserServiceImpl implements UserService {
    ...
    public UserDto createUser(User user) {
        ...
        return AppUtil.entityToDto(user, UserDto.class);
    ...
    public List<UserResponseDto> getAllUser() {
        ...
        return userRepository
                .findAll()
                .stream()
                .map(user -> AppUtil.entityToDto(user, UserResponseDto.class))
                .toList();
    }
    ...
    public UserResponseDto getUserById(String id) {
        ...
        UserResponseDto dto = AppUtil.entityToDto(user, UserResponseDto.class);
    ...
    @Override
    public List<UserResponseDto> getUserByName(String firstname) {
        return userRepository
